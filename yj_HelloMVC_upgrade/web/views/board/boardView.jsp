		    	...
		    	<div id="comment-container">
		    		...
		    		<div class="comment-editor">
		    			...
		    			<form action="<%=request.getContextPath() %>/board/insertBoardComment.do" method="post" >
			    				...
			    				<input type="hidden" name="commentWriter" value="<%=loginMember != null ? loginMember.getUserid() : "" %>"> <!-- 주의: 댓글쓴 사람은 로그인한 사람임  -->
		    			...
		    			<% if(bc.getBoardCommentLevel() == 1) { %>
			    			...
			    			<tr class="level1">
			    				...
			    				<td>
			    					...
			    					<% if(loginMember != null && ( loginMember.getUserid().equals(bc.getBoardCommentWriter()) || loginMember.getUserid().equals("admin")) ) { %>
